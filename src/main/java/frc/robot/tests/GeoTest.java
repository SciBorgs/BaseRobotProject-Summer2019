...
public class GeoTest {
    ...
    public static void testGeo() {
        ...
        Tester.assertTrue(Geo.areParallel(parallelRay1, parallelRay2), "areParallel, Test #4");

        Tester.assertTrue(Geo.areParallel(parallelSegment1, parallelSegment2), "areParallel, Test #5");

        Tester.assertFalse(Geo.areParallel(notParallelLine1, notParallelLine2), "areParallel, Test #6");
