...
public class Triangulation {
    ...
    public Triangulation(HashSet<Point> points) {
        ...
        this.triangulatedEdges = new HashSet<>();
    }

    public HashSet<Edge> triangulate() {
    ...
    private void deleteEdge(Edge edge) {
        ...
        splice(edge.symEdge, edge.symEdge.prevOrigin);
        this.triangulatedEdges.remove(edge);
        this.triangulatedEdges.remove(edge.symEdge);
    }
